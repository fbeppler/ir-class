package com.fbeppler.ir.commons.tools;

import java.util.Locale;

/**
 * A stemmer for Brazilian Portuguese words.<br>
 * 
 * The original class was implemented in Lucene project (http://lucene.apache.org/).
 * 
 */
public class BrazilianStemmer {
	...
	private void createCT(String term) {
		...
		if ((CT.charAt(0) == '"') || (CT.charAt(0) == '\'') || (CT.charAt(0) == '-') || (CT.charAt(0) == ',')
				|| (CT.charAt(0) == ';') || (CT.charAt(0) == '.') || (CT.charAt(0) == '?') || (CT.charAt(0) == '!')) {
			CT = CT.substring(1);
		}
		...
		if ((CT.charAt(CT.length() - 1) == '-') || (CT.charAt(CT.length() - 1) == ',')
				|| (CT.charAt(CT.length() - 1) == ';') || (CT.charAt(CT.length() - 1) == '.')
				|| (CT.charAt(CT.length() - 1) == '?') || (CT.charAt(CT.length() - 1) == '!')
				|| (CT.charAt(CT.length() - 1) == '\'') || (CT.charAt(CT.length() - 1) == '"')) {
	 ...
	 */
	public String log() {
		return " (TERM = " + TERM + ")" + " (CT = " + CT + ")" + " (RV = " + RV + ")" + " (R1 = " + R1 + ")" + " (R2 = "
				+ R2 + ")";
	}
